...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("sistemasTrnasaccionales");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("sistemasTrnasaccionales");
        ...
        config.getMapConfigs().put("co.sistemas.transaccionales.uniminuto.domain.*", initializeDomainMapConfig(jHipsterProperties));
